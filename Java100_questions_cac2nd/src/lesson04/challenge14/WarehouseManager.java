...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < jankenArray2.length; i++) {
			...
			jankenArray2[i] = (int) (Math.random() * 10) % 3 + 1;
			if (jankenArray2[i] == 1) {
				stoneCount2++;
				if (stoneCount2 >= 3) {
					i--;
		...
		for (int count = 0; count < 5; count++) {
			...
			do {
				...
				String konte = br.readLine();
				openNum1 = Integer.parseInt(konte) - 1;
				if (openNum1 == 0) {
					conte1++;
					if (conte1 > 1) {
			...
			if ((jankenArray1[openNum1] == 1 && jankenArray2[openNum2] == 1)
					|| (jankenArray1[openNum1] == 2 && jankenArray2[openNum2] == 2)
					|| (jankenArray1[openNum1] == 3 && jankenArray2[openNum2] == 3)) {
				System.out.println("Yさん：");
			...
			} else if ((jankenArray1[openNum1] == 1 && jankenArray2[openNum2] == 2)
				...
				winPoint++;
			} else if ((jankenArray1[openNum1] == 1 && jankenArray2[openNum2] == 3)
					|| (jankenArray1[openNum1] == 2 && jankenArray2[openNum2] == 1)
					|| (jankenArray1[openNum1] == 3 && jankenArray2[openNum2] == 2)) {
				System.out.println("Yさん：");
