...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		//配列の宣言および初期化処理を記述する
		String[] aisa = new String[3];
		aisa[0] = "へい！らっしゃい！！";
		aisa[1] = "何にしますか！今日は活きのいいコハダが入ってますよ";
		aisa[2] = "まいどあり！！またどうぞ";
		...
		for (int i = 0; i < aisa.length; i++) {
			System.out.println("あいさつパターン" + (i + 1) + "...「" + aisa[i] + "」\n");
		}
		...
		int heko = Integer.parseInt(str);

		aisa[heko - 1] = null;

		System.out.print("\nあいさつを吹き込んでください＞");
		String arata = br.readLine();
